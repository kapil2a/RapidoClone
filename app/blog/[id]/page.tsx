...
export default async function BlogDetailPage({
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt:
        "Learn about the rigorous safety measures we implement to ensure every ride meets Formula 1 safety standards.",
      content: `
    ...
    },
    {
      ...
      excerpt:
        "Explore the differences between our MotoGP bike rides and F1 car experiences to find your perfect racing match.",
      content: `
